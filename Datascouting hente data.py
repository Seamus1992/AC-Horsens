...
# Convert the events_list to a DataFrame
df = pd.DataFrame(players_list)
df.to_csv('Individuelt dashboard U17.csv',index=False)
print('Matchstats hentet')
json_files = []
...
# Convert the events_list to a DataFrame
df = pd.DataFrame(players_list)
df.to_csv('Individuelt dashboard U19.csv',index=False)
print('Matchstats hentet')
json_files = []
...
# Convert the events_list to a DataFrame
df = pd.DataFrame(players_list)
df.to_csv('Individuelt dashboard U17 div.csv',index=False)
print('Matchstats hentet')
json_files = []
...
connection_string = 'SharedAccessSignature=sv=2020-08-04&ss=f&srt=sco&sp=rl&se=2025-01-11T22:47:25Z&st=2022-01-11T14:47:25Z&spr=https&sig=CXdXPlHz%2FhW0IRugFTfCrB7osNQVZJ%2BHjNR1EM2s6RU%3D;FileEndpoint=https://divforeningendataout1.file.core.windows.net/;'
share_name = 'divisionsforeningen-outgoingdata'
dir_path = 'KampData/Sæson 22-23/U19 Division/'
...
# Convert the events_list to a DataFrame
df = pd.DataFrame(players_list)
df.to_csv('Individuelt dashboard U19 div.csv',index=False)
print('Matchstats hentet')
json_files = []
...
connection_string = 'SharedAccessSignature=sv=2020-08-04&ss=f&srt=sco&sp=rl&se=2025-01-11T22:47:25Z&st=2022-01-11T14:47:25Z&spr=https&sig=CXdXPlHz%2FhW0IRugFTfCrB7osNQVZJ%2BHjNR1EM2s6RU%3D;FileEndpoint=https://divforeningendataout1.file.core.windows.net/;'
share_name = 'divisionsforeningen-outgoingdata'
dir_path = 'KampData/Sæson 22-23/Superliga/'
...
# Convert the events_list to a DataFrame
df = pd.DataFrame(players_list)
df.to_csv('Individuelt dashboard Superliga.csv',index=False)
print('Matchstats hentet')
json_files = []
...
connection_string = 'SharedAccessSignature=sv=2020-08-04&ss=f&srt=sco&sp=rl&se=2025-01-11T22:47:25Z&st=2022-01-11T14:47:25Z&spr=https&sig=CXdXPlHz%2FhW0IRugFTfCrB7osNQVZJ%2BHjNR1EM2s6RU%3D;FileEndpoint=https://divforeningendataout1.file.core.windows.net/;'
share_name = 'divisionsforeningen-outgoingdata'
dir_path = 'KampData/Sæson 22-23/1st Division/'
...
# Convert the events_list to a DataFrame
df = pd.DataFrame(players_list)
df.to_csv('Individuelt dashboard 1.div.csv',index=False)
print('Matchstats hentet')
json_files = []
...
connection_string = 'SharedAccessSignature=sv=2020-08-04&ss=f&srt=sco&sp=rl&se=2025-01-11T22:47:25Z&st=2022-01-11T14:47:25Z&spr=https&sig=CXdXPlHz%2FhW0IRugFTfCrB7osNQVZJ%2BHjNR1EM2s6RU%3D;FileEndpoint=https://divforeningendataout1.file.core.windows.net/;'
share_name = 'divisionsforeningen-outgoingdata'
dir_path = 'KampData/Sæson 22-23/2nd Division/'
...
# Convert the events_list to a DataFrame
df = pd.DataFrame(players_list)
df.to_csv('Individuelt dashboard 2.div.csv',index=False)
print('Matchstats hentet')
json_files = []
...
connection_string = 'SharedAccessSignature=sv=2020-08-04&ss=f&srt=sco&sp=rl&se=2025-01-11T22:47:25Z&st=2022-01-11T14:47:25Z&spr=https&sig=CXdXPlHz%2FhW0IRugFTfCrB7osNQVZJ%2BHjNR1EM2s6RU%3D;FileEndpoint=https://divforeningendataout1.file.core.windows.net/;'
share_name = 'divisionsforeningen-outgoingdata'
dir_path = 'KampData/Sæson 22-23/3. Division/'
...
# Convert the events_list to a DataFrame
df = pd.DataFrame(players_list)
df.to_csv('Individuelt dashboard 3.div.csv',index=False)
print('Matchstats hentet')
json_files = []
