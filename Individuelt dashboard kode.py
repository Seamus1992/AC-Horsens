...
df = df.astype(str)
dfevents = pd.read_csv(r'C:\Users\SéamusPeareBartholdy\Documents\GitHub\AC-Horsens\U15 eventdata.csv',low_memory=False)
...
df = df[['Player name','matchId','label','date','position_names','position_codes','total','average','percent']]
