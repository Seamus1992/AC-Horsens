...
def GPS_Data():
    ...
    dforiginal = pd.read_csv(r'C:\Users\SéamusPeareBartholdy\Desktop\Data app\samlet gps data.csv')
...
image = Image.open(r'C:\Users\SéamusPeareBartholdy\Desktop\Data app\Logo.png')
